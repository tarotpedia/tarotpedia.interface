export const vi = {
  ...
  tarotGuide: {
    ...
    subtitle:
      'Khám phá ý nghĩa và biểu tượng của từng lá bài tarot trong bộ bài. Nhấp vào bất kỳ lá bài nào bên dưới để tìm hiểu thêm về ý nghĩa, khía cạnh bói toán và những hiểu biết sâu sắc hơn. Bộ bài gồm 78 lá bài, được chia thành hai phần: Major Arcana (22 lá) và Minor Arcana (56 lá).',
    majorArcana: 'Major Arcana',
    minorArcana: 'Minor Arcana',
    cardDetails: 'Chi Tiết Lá Bài Tarot',
    cardNumber: 'Thứ Tự Trong Bộ Bài:',
    fortuneTelling: 'Bói Toán',
    lightMeanings: 'Nghĩa Sáng (Thuận)',
    shadowMeanings: 'Nghĩa Tối (Ngược)',
    archetype: 'Nguyên Mẫu',
    questionsToAsk: 'Câu Hỏi Để Hỏi',
    symbolism: 'Biểu Tượng & Tương Ứng',
    hebrewAlphabet: 'Bảng Chữ Cái Do Thái:',
    numerology: 'Thần Số Học:',
    element: 'Nguyên Tố:',
    mythicalSpiritual: 'Kết Nối Thần Thoại & Tâm Linh',
    note: 'Lưu ý: Chúng tôi không dịch ý nghĩa của các lá bài tarot sang tiếng Việt để đảm bảo sát nghĩa và chính xác nhất.',
  },
} as const;
