...
export default function Footer() {
  return (
    <footer className="relative z-10 border-t border-[#d3d2ca] bg-[#fdfdf8] mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          <div>
            ...
            <p className="text-sm text-[#3d3a2a] leading-relaxed">
              Combining ancient tarot wisdom with modern AI technology to provide insightful readings and guidance for
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4">
              <a href="mailto:contact@tarotpedia.com" className="text-[#3d3a2a] hover:text-amber-600 transition-colors">
                <Mail className="w-5 h-5" />
              </a>
            </div>
            <p className="text-sm text-[#3d3a2a]">Questions or feedback? We'd love to hear from you.</p>
          </div>
        </div>
