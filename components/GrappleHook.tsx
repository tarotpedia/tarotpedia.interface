    ...
    <div className="relative max-w-2xl mx-auto">
      ...
      >
        <svg viewBox="0 0 80 220" className="w-full h-auto">
          {/* metal ring at top */}
          <circle cx="40" cy="4" r="4" fill="#8b7355" stroke="#5a4633" strokeWidth="1" />
          {/* rope */}
          <path
            d="M40 8 C40 40 40 80 40 120"
            stroke="#6b4f2a"
            strokeWidth="2.5"
            fill="none"
            strokeLinecap="round"
