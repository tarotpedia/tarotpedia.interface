  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        pre: p => <pre className="bg-[#1a1819] p-4 rounded-lg overflow-x-auto mb-4" {...p} />,
        blockquote: p => (
          <blockquote
        ...
        table: p => (
          <div className="w-full overflow-x-auto mb-6">
            <table className="min-w-full border border-[#c19670]/30 rounded-lg text-sm text-[#c3beb6]" {...p} />
          </div>
        ),
